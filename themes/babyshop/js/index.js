...
(function() {
  ...
  if (window.matchMedia) {
    var setMode = function() {
      if (mql.matches) {
        ...
        document.body.classList.add('desktop'); // Should be mobile
      } else {
  ...
  var scenes = APP_DATA.scenes.map(function(sceneData) {
    var source = Marzipano.ImageUrlSource.fromString(
      "/themes/babyshop/images/tiles/" + sceneData.id + "/{z}/{f}/{y}/{x}.jpg", {
        cubeMapPreviewUrl: "/themes/babyshop/images/tiles/" + sceneData.id + "/preview.jpg"
      });
  ...
  // Set handler for scene switch.
  scenes.forEach(function(scene) {
    var el = document.querySelector('#leftMenu .nav-buttons[data-id="' + scene.data.id + '"]');
    el.addEventListener('click', function() {
      switchScene(scene);
      // On mobile, hide scene list after selecting a scene.
      if (document.body.classList.contains('mobile')) {
  ...
  // Set handler for scene switch.
  scenes.forEach(function(scene) {
    var el = document.querySelector('#rightMenu .nav-buttons[data-id="' + scene.data.id + '"]');
    el.addEventListener('click', function() {
      switchScene(scene);
      // On mobile, hide scene list after selecting a scene.
      if (document.body.classList.contains('mobile')) {
  ...
  function createLinkHotspotElement(hotspot) {
    ...
    icon.src = '/themes/babyshop/images/img/link.png';
  ...
  function createInfoHotspotElement(hotspot) {
    ...
    var icon = document.createElement('img');
    icon.src = '/themes/babyshop/images/img/info.png';
    ...
    closeIcon.src = '/themes/babyshop/images/img/close.png';
